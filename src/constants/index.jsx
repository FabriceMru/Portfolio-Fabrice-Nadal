...
export const plans = [
  {
    ...
    features: [
      ...
      "Express: Grundlegende REST-APIs, Routing",
      "React: Redux/Context, Komponenten, State Management, Hooks",
      "Node.js: Server-Setup, NPM, grundlegende Middleware",
    ],
  ...
  },
  {
    ...
    features: [
      ...
      "Projektleitung für größere Anwendungen",
      "Storage-Management für große Datenmengen (1TB+)",
      "Entwicklung analytischer Dashboards",
    ],
  ...
  },
  {
    ...
    features: [
      ...
      "Team-Leitung und Mentoring",
      "Architektur großer Systeme (10TB+ Datenverwaltung)",
      "Enterprise-Level Performance-Optimierung",
    ],
...
export const links = [
  {
    ...
    title: "Ios",
    icon: <Ios />,
    url: "/downloads/Lebenslauf_Zertifikate.zip",
  },
  {
    id: "1",
    title: "Android",
...
export const socials = [
  {
    id: "0",
    title: "GitHub",
    icon: "/images/mdi-logo-github.svg",
    url: "https://github.com/FabriceMru",
  },
  {
    id: "1",
    title: "Website",
    icon: "/images/mdi-logo-website.svg",
    url: "https://www.fabricenadal.com/",
  },
  {
    id: "2",
    title: "Linkedin",
    icon: "/images/mdi-logo-linkedin.svg",
    url: "https://www.linkedin.com/in/fabrice-nadal/",
  },
  {
    id: "3",
    title: "Stackoverflow",
    icon: "/images/mdi-logo-stackoverflow.svg",
